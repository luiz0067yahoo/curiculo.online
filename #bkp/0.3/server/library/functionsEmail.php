<?php
    ...
    use PHPMailer\PHPMailer\PHPMailer;
     ...
     if (!function_exists('sendEmail')){
    		function sendEmail($host,$username,$name_contact,$password,$subject,$email,$name_send,$urlBody){
    		    require($_SERVER['DOCUMENT_ROOT'].'/server/library/vendor/autoload.php');
